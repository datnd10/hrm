...
export class UserComponent implements OnInit {
  ...
  columnArray: any[] = [
    ...
    { header: "Email", fieldName: "email", dataType: "string", width: "200px" },
    {
  ...
  bases: any[] = [
    { name: "Chi nhánh 1", code: "branch1" },
    { name: "Chi nhánh 2", code: "branch2" },
    { name: "Chi nhánh 3", code: "branch3" },
  ];
